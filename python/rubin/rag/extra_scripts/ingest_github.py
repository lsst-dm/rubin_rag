...
def load_org(n_repo_max=2, org_name='lsst-dm') -> list:
    ...
    # this will give an output 'list' of repos sorted from most to least recently updated
    api_url = "https://api.github.com/orgs/" + org_name + "/repos?per_page=100&sort=updated"
