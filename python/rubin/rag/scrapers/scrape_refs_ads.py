...
"""Scrape the refs_ads file from lsst-texmf using the ADS API."""
        ...
        try:
            with NamedTemporaryFile(suffix=".pdf") as tmp:
                ...
                for doc in docs:
                    ...
                    doc.metadata["source_key"] = "refs_ads"
                return docs
...
def process_entry(
    ...
    try:
        ...
        _log.warning(f"Failed to scrape {paper_name}: {e}")
    else:
...
def scrape_refs_ads(yaml_path: str, output_dir: str) -> None:
    ...
    ----------
    yaml_path: str
        String of path to refs_ads_sources.yaml
    output_dir: str
